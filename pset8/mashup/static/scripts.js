...
{
    // Check latitude and longitude of the place
    var latLng = {lat: place.latitude, lng: place.longitude};
    // Instantiate the marker on the 'latLng' of 'place'
    ...
    // ask for articles (JSON)
    var parameters = {
        geo: place.postal_code
    };
    $.getJSON(Flask.url_for("articles"), parameters)
    .done(function(data, textStatus, jqXHR) {
        // Turn data article into an unordered list (HTML content)
        var content = "<div>" + "<ul>";
